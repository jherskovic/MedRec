function medrec() {
    ...
    n && n({moduleName:P, sessionId:o, subSystem:Q, evtGroup:R, millis:(new Date).getTime(), type:S});
    ...
    function B() {
        if (p && q) {
            ...
            medrec = null;
            c.gwtOnLoad(y, P, s, x);
            n && n({moduleName:P, sessionId:o, subSystem:Q, evtGroup:W, millis:(new Date).getTime(), type:X})
        }
    }
    ...
    medrec.onScriptLoad = function () {
        if (H) {
            q = true;
            B()
        }
    };
    medrec.onInjectionDone = function () {
        p = true;
        n && n({moduleName:P, sessionId:o, subSystem:Q, evtGroup:Ob, millis:(new Date).getTime(), type:X});
        B()
    };
    D();
    C();
    ...
    function N() {
        if (!r) {
            r = true;
            if (!__gwt_stylesLoaded[Zb]) {
                var a = m.createElement($b);
                __gwt_stylesLoaded[Zb] = a;
                a.setAttribute(_b, ac);
                a.setAttribute(bc, s + Zb);
                m.getElementsByTagName(cc)[0].appendChild(a)
            }
            B();
            if (m.removeEventListener) {
                m.removeEventListener(dc, N, false)
            }
            if (M) {
                clearInterval(M)
            }
    ...
    if (m.addEventListener) {
        m.addEventListener(dc, function () {
            I();
            N()
        }, false)
    }
    ...
    n && n({moduleName:P, sessionId:o, subSystem:Q, evtGroup:R, millis:(new Date).getTime(), type:X});
    n && n({moduleName:P, sessionId:o, subSystem:Q, evtGroup:Ob, millis:(new Date).getTime(), type:S});
    m.write(ec)
}
medrec();