...
class TestMedParsing(unittest.TestCase):
    ...
    def _parseHorse(self, m, d, i):
        ...
        for field in parsedFields:
            ...
            givenVal = d[field]
            self.assertEqual(parsedVal, givenVal,
                'Incorrect parsing of %s in example %d: "%s" vs "%s"' % (field, i + 1, parsedVal, givenVal))
...
class TestMedication(unittest.TestCase):
    ...
    def test_normalize_string(self):
        ...
        for original_string in self.original_strings:
            ...
            self.assertEqual(self.normalized_string, medInstance.normalized_string,
    ...
    def test_original_string(self):
        ...
        for original_string in self.original_strings:
            i += 1
            medInstance = medication.Medication(original_string)
            self.assertEqual(medInstance.original_string, original_string,
...
class TestParsedMedication(unittest.TestCase):
    ...
    @unittest.skipUnless(os.path.isfile(drugProbFname),
